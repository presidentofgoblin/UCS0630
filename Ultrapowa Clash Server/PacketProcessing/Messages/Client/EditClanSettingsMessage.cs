        ...
        public override void Decode()
        {
            using (var br = new BinaryReader(new MemoryStream(GetData())))
            {
                ...
                m_vAllianceOrigin = br.ReadInt32WithEndian();
                  ...
                  Debugger.WriteLine("\t" + m_vAllianceBadgeData.ToString(), null, 5);
                  Debugger.WriteLine("\t" + m_vAllianceType.ToString(), null, 5);
                  Debugger.WriteLine("\t" + m_vRequiredScore.ToString(), null, 5);
                  Debugger.WriteLine("\t" + m_vWarFrequency.ToString(), null, 5);
                  Debugger.WriteLine("\t" + m_vAllianceOrigin.ToString(), null, 5);
            }
        }
